  ...
  const timelineEntries = [
    {
      ...
      description: "The Toyota Prius is the perfect choice for solo travelers or small groups who prefer a smooth, fuel-efficient ride around the island. Ideal for city transfers and day trips.",
      features: [
    ...
    },
    {
      ...
      description: "The Toyota Hiace KDH offers spacious seating and reliable performance for families, business teams, and travel groups exploring Sri Lanka together.",
      features: [
    ...
    },
    {
      ...
      description: "Our Toyota High Roof is built for large group transfers, excursions, and sightseeing trips. Travel in comfort with plenty of room for everyone and their luggage.",
      features: [
    ...
    <div className="min-h-screen bg-white">
      ...
      <section id="about" className="relative min-h-screen flex items-center justify-center py-20 bg-white">
        ...
        <div className="container mx-auto px-6 relative z-10 mt-[-80px]">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl lg:text-6xl font-black tracking-wider mb-12 text-gray-900">
              ABOUT US
            </h2>
            <TextGradientScroll
        ...
        <div className="relative z-10">
          <div className="container mx-auto px-6 mb-16">
            <div className="text-center">
              <h2 className="text-3xl md:text-4xl lg:text-6xl font-black tracking-wider mb-6 text-gray-900">
      ...
      <section id="testimonials" className="relative py-20 bg-white">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <h2 className="text-3xl md:text-4xl lg:text-6xl font-black tracking-wider text-gray-900 mb-6">
              See what our{" "}
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-12">
