        ...
        >
          <div className="text-center text-white max-w-4xl mx-auto px-6">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-gray-200 mb-8 leading-relaxed font-medium">
              Discover why travelers across Sri Lanka choose Taxi Hub
              <br className="hidden md:block" />
              comfort, safety, and unforgettable journeys, wherever the road takes you.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Global Travelers</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Cover Cities</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Days of Availability</div>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs md:text-sm text-gray-300 font-medium">Complete Rides</div>
              </div>
            </div>
            ...
            <LiquidButton
              size="xxl"
              className="font-bold text-xl tracking-wide px-12 py-4  text-accent  hover:scale-105 transition-all duration-300"
              >
              BOOK NOW
            </LiquidButton>
            ...
            <div className="mt-12 pt-6 border-t border-white/20">
              <p className="text-xs text-gray-400 mb-3 font-medium">TRUSTED TAXI PARTNER</p>
              <div className="flex flex-wrap justify-center items-center gap-4 text-gray-300">
                ...
                <span className="text-xs font-semibold">🌍 EXPLORE EVERYWHERE</span>
                <span className="text-xs font-semibold">🏆 HIGH COMPLETE RATE</span>
                <span className="text-xs font-semibold">💯 TRUSTED RIDE</span>
              </div>
            </div>
          </div>
        </motion.div>
